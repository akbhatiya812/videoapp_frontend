...
import { verifyForgotValidationSchema } from "../../utils/schema";
import { useDispatch, useSelector } from "react-redux";
import { toast } from "react-toastify";
import { VerifyForgotPass } from "../../redux/reducer";
...
const VerifyForgotPassword = () => {
  ...
  const submitHandler = async (values) => {
    setLoading(true);
    const data = values;
    dispatch(VerifyForgotPass({ data, navigate, toast, setLoading }));
    setLoading(true);
  };
          ...
          <div className="p-5 md:p-10 w-full">
            ...
            <div className="">
              ...
              <p className="text-[16px] text-[#647589] font-normal mb-5">
                Welcome to chitchat please verify your account.
              </p>
            </div>
            <div className="">
              <Formik
                ...
                validationSchema={verifyForgotValidationSchema}
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-3 sm:gap-6">
                      <div className="flex flex-col gap-3">
                        ...
                        />
                        {errors.forgotPasswordOtp && (
                          <p className="text-sm text-red-500">
                            {errors.forgotPasswordOtp &&
                              touched.forgotPasswordOtp &&
                              errors.forgotPasswordOtp}
                          </p>
                        )}
                      </div>
