  ...
  return (
    ...
    >
      <div className="relative">
        <div
          className={`flex justify-between xl:mx-[150px] w-full max-w-[1600px] items-center duration-500  ${
            visible
              ? "p-[25px_50px] gap-3  sm:p-[25px_100px] rounded-[30px] shadow-lg bg-[#278BFF]"
        ...
        >
          ...
          <div className="hidden lg:flex items-center gap-10 text-white font-bold text-[17px] capitalize text-nowrap ">
            ...
            <h4 className="hover:text-[#1c6ee9] cursor-pointer">Hire Us</h4>
          ...
          <div>
            {storage ? (
              ...
              <Link
                to={"/login"}
                className="bg-white hidden lg:flex text-[#212529c7] capitalize  rounded-[5px] w-[max-contein] font-bold p-[15px_40px]"
              >
                Login/Signup
              </Link>
            )}
